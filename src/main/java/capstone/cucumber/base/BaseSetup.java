...
import capstone.cucumber.config.Browser;
import capstone.cucumber.config.ChromeBrowser;
import capstone.cucumber.config.ChromeHeadless;
import capstone.cucumber.config.EdgeBrowser;
import capstone.cucumber.config.FireFoxBrowser;
import capstone.cucumber.utilities.ReadYamlFiles;
...
public class BaseSetup {
	...
	public BaseSetup() {
	  ...
	  //these line of codes will switch the exce based on value we pass
